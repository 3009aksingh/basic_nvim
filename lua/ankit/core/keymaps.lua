...
keymap.set("n", "<A-0>", ":Buffers<CR>", opts)
keymap.set("n", "<A-c>", ":BufferLinePickClose<CR>", opts)
keymap.set("n", "<C-p>", ":BufferLinePick<CR>", opts)
keymap.set("n", "<leader>bt", ":BufferLineSortByTabs<CR>", opts)
keymap.set("n", "<leader>bd", ":BufferLineSortByDirectory<CR>", opts)
keymap.set("n", "<leader>bp", ":BufferLineTogglePin<CR>", opts)

-- ---------==> Mapping for Toggleterm <==-------------
-- check at location: ankit/plugins/toggleterm.lua
-- search open_mapping to know the keymapping for ToggleTerm.
...
keyset("n", "gf", "<Plug>(coc-references)", { silent = true })
...
keyset("n", "<>", ":<C-u>CocList diagnostics<cr>", opts) -- need to setup keymaps for all keyset mentioned below
-- Manage extensions.
keyset("n", "<>", ":<C-u>CocList extensions<cr>", opts)
-- Show commands.
keyset("n", "<>", ":<C-u>CocList commands<cr>", opts)
-- Find symbol of current document.
keyset("n", "<>", ":<C-u>CocList outline<cr>", opts)
-- Search workspace symbols.
keyset("n", "<>", ":<C-u>CocList -I symbols<cr>", opts)
-- Do default action for next item.
keyset("n", "<>", ":<C-u>CocNext<cr>", opts)
-- Do default action for previous item.
keyset("n", "<>", ":<C-u>CocPrev<cr>", opts)
-- Resume latest coc list.
keyset("n", "<>", ":<C-u>CocListResume<cr>", opts)
...
-- Keymap  for Ranger :
keymap.set("n", "<A-r>", ":RnvimrToggle<CR>")

-- Keymap for refactoring :
